...
describe("case-grouping", () => {
  ...
  describe("groupStepsByCase with plannedCases", () => {
    ...
    it("correctly preserves total steps and pass rollup for cases with mixed PASS and SKIP steps in a PASS run", () => {
      const planned = [
        { case_id: "c_1", case_public_id: "TC-1", case_title: "Mixed Steps Case", total_steps: 2 },
      ];
      const steps = [
        makeStep({ id: "s_1", case_id: "c_1", outcome: "PASS", step_order: 0 }),
        makeStep({ id: "s_2", case_id: "c_1", outcome: "SKIP", step_order: 1 }),
      ];
